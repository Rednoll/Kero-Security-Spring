...
import com.kero.security.spring.config.KeroAccessAgentFactoryBuilderBean;

@RunWith(SpringRunner.class)
@SpringBootTest(classes = {KeroAccessAgentBean.class, KeroAccessAgentFactoryBean.class, KeroAccessAgentFactoryBuilderBean.class, KeroAccessAgentConfiguratorBeans.class})
@ActiveProfiles("test")
